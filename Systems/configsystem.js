...
console.log('🚀 [configsystem.js] Loading version 2.5.6...');
...
async function resumeTicketState(client) {
  ...
  console.log(`🔍 [SYSTEM - TICKETS VER: 2.5.6] Analyse et restauration pour ${Object.keys(configData.guilds).length} serveur(s)...`);
...
async function resumeTicketState(client) {
  if (!configData.guilds) return;
  console.log(`🔍 [SYSTEM - TICKETS VER: 2.5.0] Analyse et restauration pour ${Object.keys(configData.guilds).length} serveur(s)...`);
