...
console.log('🚀 [configsystem.js] Loading version 1.9.2...');
const {
  ActionRowBuilder,
  ButtonBuilder,
  ButtonStyle,
...
async function resumeTicketState(client) {
  ...
  console.log(`🔍 [SYSTEM - TICKETS VER: 1.9.2] Analyse et restauration pour ${Object.keys(configData.guilds).length} serveur(s)...`);
