...
console.log('🚀 [configsystem.js] Loading version 2.5.8...');
...
async function resumeTicketState(client) {
  ...
  console.log(`🔍 [SYSTEM - TICKETS VER: 2.5.8] Analyse et restauration pour ${Object.keys(configData.guilds).length} serveur(s)...`);
