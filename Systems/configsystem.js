...
console.log('🚀 [configsystem.js] Loading version 2.8.9...');
...
async function resumeTicketState(client) {
  ...
  console.log(`🔍 [SYSTEM - TICKETS VER: 2.7.8] Analyse et restauration pour ${Object.keys(configData.guilds).length} serveur(s)...`);
