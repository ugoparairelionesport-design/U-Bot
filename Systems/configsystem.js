...
console.log('🚀 [configsystem.js] Loading version 1.7.8...');
const {
  ActionRowBuilder,
  ButtonBuilder,
  ButtonStyle,
...
async function resumeTicketState(client) {
  ...
  console.log(`🔍 [SYSTEM - TICKETS VER: 1.7.8] Analyse et restauration pour ${Object.keys(configData.guilds).length} serveur(s)...`);
