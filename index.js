...
console.log('🚀 [index.js] Loading version 2.0.2...');
const {
  Client,
  GatewayIntentBits,
  Partials,
...
client.on('interactionCreate', async interaction => {
  try {
    ...
    console.log(`⚡ [VER: 2.0.2] Interaction: ${interaction.type} | Nom: ${isCommand ? interaction.commandName : 'non-command'} | ID: ${interaction.customId || 'N/A'}`);
