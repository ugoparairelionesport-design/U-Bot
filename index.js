...
console.log('🚀 [index.js] Loading version 1.7.0...');
const {
  Client,
  GatewayIntentBits,
  Partials,
...
client.on('interactionCreate', async interaction => {
  try {
    ...
    console.log(`⚡ [VER: 1.7.0] Interaction: ${interaction.type} | Nom: ${isCommand ? interaction.commandName : 'non-command'} | ID: ${interaction.customId || 'N/A'}`);
