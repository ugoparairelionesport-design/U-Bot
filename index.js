...
console.log('🚀 [index.js] Loading version 2.0.4...');
const {
  Client,
  GatewayIntentBits,
  Partials,
...
client.on('interactionCreate', async interaction => {
  try {
    ...
    console.log(`⚡ [VER: 2.0.4] Interaction: ${interaction.type} | Nom: ${isCommand ? interaction.commandName : 'non-command'} | ID: ${interaction.customId || 'N/A'}`);
